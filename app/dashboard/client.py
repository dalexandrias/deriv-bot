...
from app.dashboard.event_client import AutoReconnectEventClient
from app.dashboard.db_reader import DBReader
from app.dashboard.widgets.status_panel import StatusPanel
from app.dashboard.widgets.overview_panel import OverviewPanel
from app.dashboard.widgets.market_panel import MarketPanel
from app.dashboard.widgets.active_panel import ActivePanel
from app.dashboard.widgets.history_panel import HistoryPanel
from app.dashboard.widgets.stats_panel import StatsPanel
from app.dashboard.widgets.log_panel import LogPanel
...
class DashboardApp(App):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield StatusPanel()
        with TabbedContent():
            yield TabPane("Visao Geral", OverviewPanel(), id="tab-overview")
            yield TabPane("Mercado",     MarketPanel(),   id="tab-market")
            yield TabPane("Sinais",      ActivePanel(),   id="tab-active")
            yield TabPane("Historico",   HistoryPanel(),  id="tab-history")
