"""Painel Visao Geral -- tela consolidada de status, mercado, sinal ativo e mini-log."""
...
def _build_pre_block(pre: dict) -> Text:
    ...
    win_s = "green" if window == "FAVORAVEL" else "red"
