"""Painel de historico de sinais com header sumario, coluna delta e streak no rodape."""
...
class HistoryPanel(Vertical):
    """Historico com filtros, coluna delta e streak visual."""

    BINDINGS = [
        Binding("1", "filter_wins", "So wins"),
        Binding("2", "filter_losses", "So losses"),
        Binding("3", "filter_aborted", "So aborted"),
    ...
    def on_mount(self) -> None:
        ...
        table.add_column("Saida", width=9)
